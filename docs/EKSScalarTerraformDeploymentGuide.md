...
```console
$ cd ${SCALAR_K8S_HOME}/modules/aws/network
...
```console
$ cd ${SCALAR_K8S_HOME}/modules/aws/kubernetes
...
```console
$ cd ${SCALAR_K8S_HOME}/modules/aws/cassandra
...
```console
$ cd ${SCALAR_K8S_HOME}/modules/aws/monitor
