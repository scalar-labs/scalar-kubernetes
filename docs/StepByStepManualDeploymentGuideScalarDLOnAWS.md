...
* On the **Attach to VPC** page, configure the following options
  * Select your _VPC_ from **Available VPCs** dropdown
...
* On the **Route tables** page, configure routes to direct Internet access to the VPC to public subnets
  ...
  * On the details pane, select **Routes** tab
  * Select **Edit routes**
...
Create a route table for NAT gateways, repeat the following steps for all NAT gateways
* In the navigation pane, choose **Route Tables**
* Select **Create route table**
  * Enter **Name tag**
  * Select your **VPC** from dropdown
  * Select **Create route table**
  * Select **Close**
* On the **Route tables** page, configure routes and associate subnets for private Route tables using following steps
  * Select previously created Route table
  * On the details pane, select **Routes** tab
  * Select **Edit routes**
  * On the **Edit routes** page, configure the following options
...
* On the **Configure Instance** page, configure the following options
  ...
  * Select **Auto-assign Public IP** as _Enable_ from dropdown
...
* Select **Create record**
  ...
  * Select **Record type** as _A - Routes traffic to an IPv4 address and some AWS resources_ from dropdown
...
* For the **Version** option, choose the MySQL **Version** from dropdown
...
* On the **Connectivity** section, configure the following options
  * Select your **Virtual private cloud (VPC)** from dropdown
  * Select previously created **Subnet group** from dropdown
  * Select **Public Access** as _No_
  * Select _Create new_ for VPC security group
  * Enter **New VPC security group name**
* On **Database authentication** section, select _Password authentication_
* Select **Create database**
...
* For **Version**, choose the PostgreSQL **Version** from dropdown
* Select _Production_ in **Templates**
* On the **Settings** section, configure the following options
  * Enter **DB instance identifier** (enter name for the database must be lowercase)
...
* On the **Availability & durability**, select _Create a standby instance (recommended for production usage)_
* On the **Connectivity** section, configure the following options
  * Select your **Virtual Private Cloud** from dropdown
  * Select previously created **Subnet group** from dropdown
  * Select **Public Access** as _No_
  * Select _Create new_ for **VPC security group**
  * Enter **New VPC security group name**
...
* On the **Configure cluster** page, configure the following options
  ...
  * Select **Kubernetes version** as _1.19_  or higher from dropdown
...
* On the **Specify networking** page, configure the following options
  * Select your **VPC**
  * Select **Subnets** as previously created Kubernetes subnets, private subnets and public subnets from dropdown
  * Select _bastion_ **Security groups** from dropdown
  * Select _Public and Private_ as **Cluster endpoint access**
  * Select **Amazon VPC CNI** _v1.7.5-eksbuild.1_ from dropdown
  * Select **Next**
