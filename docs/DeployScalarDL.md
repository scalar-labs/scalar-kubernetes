...
Ensure that Cassandra is fully started and ready and re-apply the `ansible-playbook -i ${SCALAR_K8S_CONFIG_DIR}/inventory.ini operation/playbook-deploy-scalardl.yml`
