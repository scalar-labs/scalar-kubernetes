...
This guide explains how to set up a database for Scalar DL and scalar DB server.

## Cosmos DB

In this section, you will set up a Cosmos DB for Scalar DL and scalar DB server.
