...
* You should allow AKS cluster to pull containers from your private container registry (Azure Container Registry) if you use Azure Marketplace to get Scalar product containers. Please refer to [this guide](./AzureMarketplaceGuide.md) for more details of the Azure Marketplace.
